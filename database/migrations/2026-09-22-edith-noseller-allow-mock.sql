-- 2026-09-22 · คิว noseller ใน EDITH: เลิกกรองข้อมูลจำลองออก
-- เพื่อให้ทดสอบปุ่มเติมเซล/ไม่เติมเซล กับข้อมูลจำลองปี 2024 ได้ (ห้ามทดสอบกับข้อมูลจริง)
-- app_sales_dashboard ยังกรอง MOCK% ออกตามเดิม — รายงานการเงินต้องสะอาด
